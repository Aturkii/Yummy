//*_____________ DOM elements ______________

let rowData = document.getElementById("rowData");
let searchContainer = document.getElementById("searchContainer");
let submitBtn;

//*_____________ DOM ready function ______________
...
//!_____________ Side sideNav Animation functions ______________
...
//!_____________ Close sideNav Function ______________
...
//!_____________ Event listener for toggle sideNav ______________
...
//?_____________ Display meals function ______________
...
//&_____________ Function to attach click event to meals ______________
...
//?_____________ Function to Fetch categories and display them ______________
...
//&_____________ Function to attach click event to categories _______________
...
//?_____________ Function to Fetch areas and display them ______________
...
//?_____________ Display areas function ________________
...
//?_____________ Function to Fetch details of a specific meal ______________
...
//?_____________ Function to Display details of a specific meal ______________
...
//?_____________ Function to Show search inputs ______________

function showSearchInputs() {
  searchContainer.innerHTML = `
    <div class="row py-4 ">
      <div class="col-md-6 ">
        <input id="searchByNameInput" class="form-control bg-warning text-dark" type="text" placeholder="Search By Name">
      </div>
      <div class="col-md-6">
        <input id="searchByFLetterInput" maxlength="1" class="form-control bg-warning text-dark" type="text" placeholder="Search By First Letter">
      </div>
    </div>`;
...
//&_____________ Function to attach onkeyup events to search inputs ______________
...
//?_____________ Function to Search by name ______________
...
//?_____________ Function to Search by first letter ______________
...
//?_____________ Function to Show contacts form ______________
...
function showContacts() {
  ...
  //!_______________ Call the validation while Typing to display and hide the alerts ___________________ 
...
//^_____________ Function to validate all inputs and display and hide alerts ______________
...
//^_____________ Function to validate Name ______________

function nameValidation() {
  return (/^[a-zA-Z ]+$/.test(document.getElementById("nameInput").value))
}

//^_____________ Function to validate Email ______________

function emailValidation() {
  return (/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(document.getElementById("emailInput").value))
}

//^_____________ Function to validate Phone ______________

function phoneValidation() {
  return (/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/.test(document.getElementById("phoneInput").value))
}

//^_____________ Function to validate Age ______________

function ageValidation() {
  return (/^(0?[1-9]|[1-9][0-9]|[1][1-9][1-9]|200)$/.test(document.getElementById("ageInput").value))
}

//^_____________ Function to validate Password ______________

function passwordValidation() {
  return (/^(?=.*\d)(?=.*[a-z])[0-9a-zA-Z]{8,}$/.test(document.getElementById("passwordInput").value))
}

//^_____________ Function to check the RePassword ______________
